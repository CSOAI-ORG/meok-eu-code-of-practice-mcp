"""MEOK EU AI Act Compliance — Apify Actor wrapper.

AI risk classification, evidence pack generation

Built by MEOK AI Labs · eu-ai-act-compliance-mcp · MIT
"""
...
mcp = FastMCP("meok-eu-ai-act-compliance-mcp")

@mcp.tool()
def default(query: str, operation: str = "default", region: str = "EU") -> dict:
    """Default operation for EU AI Act Compliance.
