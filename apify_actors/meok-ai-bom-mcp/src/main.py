"""MEOK AI Bill of Materials — Apify Actor wrapper.

CycloneDX 1.6 AI BOM — model, datasets, dependencies, training compute

Built by MEOK AI Labs · ai-bom-mcp · MIT
"""
...
mcp = FastMCP("meok-ai-bom-mcp")

@mcp.tool()
def default(query: str, operation: str = "default", region: str = "EU") -> dict:
    """Default operation for AI Bill of Materials.
