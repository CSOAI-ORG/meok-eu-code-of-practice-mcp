"""MEOK NIS2 Compliance — Apify Actor wrapper.

Sector-based classification, registration, risk management

Built by MEOK AI Labs · nis2-compliance-mcp · MIT
"""
...
mcp = FastMCP("meok-nis2-compliance-mcp")

@mcp.tool()
def default(query: str, operation: str = "default", region: str = "EU") -> dict:
    """Default operation for NIS2 Compliance.
