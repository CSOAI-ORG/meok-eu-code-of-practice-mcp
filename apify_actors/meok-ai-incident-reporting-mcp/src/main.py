"""MEOK AI Incident Reporting — Apify Actor wrapper.

Hash-chained incident records for Article 73 + NIS2

Built by MEOK AI Labs · ai-incident-reporting-mcp · MIT
"""
...
mcp = FastMCP("meok-ai-incident-reporting-mcp")

@mcp.tool()
def default(query: str, operation: str = "default", region: str = "EU") -> dict:
    """Default operation for AI Incident Reporting.
