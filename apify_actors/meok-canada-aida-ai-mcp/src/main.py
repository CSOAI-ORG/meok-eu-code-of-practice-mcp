"""MEOK Canada AIDA AI — Apify Actor wrapper.

Canada AIDA high-impact system classification

Built by MEOK AI Labs · canada-aida-ai-mcp · MIT
"""
...
mcp = FastMCP("meok-canada-aida-ai-mcp")

@mcp.tool()
def default(query: str, operation: str = "default", region: str = "EU") -> dict:
    """Default operation for Canada AIDA AI.
