"""MEOK Bias Detection — Apify Actor wrapper.

Demographic bias detection in AI training/output

Built by MEOK AI Labs · bias-detection-mcp · MIT
"""
...
mcp = FastMCP("meok-bias-detection-mcp")

@mcp.tool()
def default(query: str, operation: str = "default", region: str = "EU") -> dict:
    """Default operation for Bias Detection.
