...
CC: (none — single decision-maker)
SUBJECT: Beamery's AI hiring + EU AI Act — 103 days to Aug 2

Hi Abakar,

Beamery's AI-driven talent platform falls squarely under Annex III of the EU AI Act — high-risk category for AI in employment decisions.

Enforcement starts August 2, 2026. 103 days from today. Penalties: up to €35M or 7% of global turnover.

For a high-risk AI hiring system, you'll need:
- Conformity assessment (Article 43)
- Bias testing across protected characteristics (Article 10)
- Documented human oversight mechanism (Article 14)
- Technical documentation pack (Article 11)
- Post-market monitoring plan (Article 61)

I run MEOK AI Labs. We've built the only ISO 42001 MCP server stack in existence — automated compliance infrastructure that audits AI systems against 13 regulatory frameworks (EU AI Act, ISO 42001, NIST AI RMF, GDPR, and 9 more).
