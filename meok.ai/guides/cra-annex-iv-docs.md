# How to write the Annex IV technical documentation

**Regulation:** CRA (Annex IV)
...
Building the 9-section technical documentation file required for CRA conformity assessment.
...
The CRA (Annex IV) is enforced as of Annex IV. Non-compliance is a fine of up to €5M or 2.5-3% of global annual turnover (whichever is higher) for CRA. Practitioners in scope need a deterministic, audit-ready reference — not a 200-page PDF.
...
Your agent will call the `cra-compliance-mcp` tool, which references the CRA Annex IV text directly. The response is structured:

```json
{
  "risk_class": "high",
  "applicable_articles": ["Annex IV", "Article 26"],
  "evidence_required": [
  ...
  "rationale": "The system processes health data of natural persons in the EU, falls within Annex III §5(a) (critical infrastructure), and meets the high-risk criteria in Annex IV."
}
```
