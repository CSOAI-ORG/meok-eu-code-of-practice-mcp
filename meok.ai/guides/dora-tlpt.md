# How to do threat-led penetration testing (TLPT)

**Regulation:** DORA (Article 26-27)
...
Setting up the TLPT cycle per the ECB's TIBER-EU framework, required for significant financial entities.
...
The DORA (Article 26-27) is enforced as of Article 26-27. Non-compliance is a fine of up to €5M or 2.5-3% of global annual turnover (whichever is higher) for DORA. Practitioners in scope need a deterministic, audit-ready reference — not a 200-page PDF.
...
Your agent will call the `dora-compliance-mcp` tool, which references the DORA Article 26-27 text directly. The response is structured:

```json
{
  "risk_class": "high",
  "applicable_articles": ["Article 26-27", "Article 26"],
  "evidence_required": [
  ...
  "rationale": "The system processes health data of natural persons in the EU, falls within Annex III §5(a) (critical infrastructure), and meets the high-risk criteria in Article 26-27."
}
```
