# How to register with your national NIS2 authority

**Regulation:** NIS2 (Article 21(4) + national)
...
Registering with ENISA via the national CSIRT. Step-by-step for UK, DE, FR, NL.
...
The NIS2 (Article 21(4) + national) is enforced as of Article 21(4). Non-compliance is a fine of up to €10M or 2.5-3% of global annual turnover (whichever is higher) for NIS2. Practitioners in scope need a deterministic, audit-ready reference — not a 200-page PDF.
...
Your agent will call the `nis2-compliance-mcp` tool, which references the NIS2 Article 21(4) + national text directly. The response is structured:

```json
{
  "risk_class": "high",
  "applicable_articles": ["Article 21(4) + national", "Article 26"],
  "evidence_required": [
  ...
  "rationale": "The system processes health data of natural persons in the EU, falls within Annex III §5(a) (critical infrastructure), and meets the high-risk criteria in Article 21(4) + national."
}
```
