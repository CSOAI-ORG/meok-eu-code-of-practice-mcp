# How to integrate ISO 42001 with ISO 27001

**Regulation:** ISO 42001 (ISO 42001 Annex A)
...
Building a unified ISMS + AIMS — overlapping controls, common policies, single audit cycle.
...
The ISO 42001 (ISO 42001 Annex A) is enforced as of ISO 42001 Annex A + ISO 27001 Annex A. Non-compliance is a fine of up to €5M or 2.5-3% of global annual turnover (whichever is higher) for ISO 42001. Practitioners in scope need a deterministic, audit-ready reference — not a 200-page PDF.
...
Your agent will call the `iso-42001-ai-mcp` tool, which references the ISO 42001 ISO 42001 Annex A text directly. The response is structured:

```json
{
  "risk_class": "high",
  "applicable_articles": ["ISO 42001 Annex A", "Article 26"],
  "evidence_required": [
  ...
  "rationale": "The system processes health data of natural persons in the EU, falls within Annex III §5(a) (critical infrastructure), and meets the high-risk criteria in ISO 42001 Annex A."
}
```
...
- Citation: ISO 42001 Annex A + ISO 27001 Annex A
