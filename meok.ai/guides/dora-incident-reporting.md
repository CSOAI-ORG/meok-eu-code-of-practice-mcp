# How to file a major ICT incident report under DORA
...
Filing the initial notification (4h), intermediate (72h), and final report under DORA Article 19.
...
The DORA (Article 19) is enforced as of Article 19(4). Non-compliance is a fine of up to €5M or 2.5-3% of global annual turnover (whichever is higher) for DORA. Practitioners in scope need a deterministic, audit-ready reference — not a 200-page PDF.
...
Your agent will call the `dora-compliance-mcp` tool, which references the DORA Article 19 text directly. The response is structured:

```json
{
  "risk_class": "high",
  "applicable_articles": ["Article 19", "Article 26"],
  "evidence_required": [
  ...
  "rationale": "The system processes health data of natural persons in the EU, falls within Annex III §5(a) (critical infrastructure), and meets the high-risk criteria in Article 19."
}
```
