# How to use Standard Contractual Clauses for AI data transfers

**Regulation:** GDPR (Article 46(2)(c))
...
Adopting the 2021 SCCs for AI training data and inference data transfers to third countries.
...
The GDPR (Article 46(2)(c)) is enforced as of Article 46(2)(c). Non-compliance is a fine of up to €7M or 2.5-3% of global annual turnover (whichever is higher) for GDPR. Practitioners in scope need a deterministic, audit-ready reference — not a 200-page PDF.
...
Your agent will call the `gdpr-compliance-ai-mcp` tool, which references the GDPR Article 46(2)(c) text directly. The response is structured:

```json
{
  "risk_class": "high",
  "applicable_articles": ["Article 46(2)(c)", "Article 26"],
  "evidence_required": [
  ...
  "rationale": "The system processes health data of natural persons in the EU, falls within Annex III §5(a) (critical infrastructure), and meets the high-risk criteria in Article 46(2)(c)."
}
```
