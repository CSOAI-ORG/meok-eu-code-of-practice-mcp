# How to handle the 2 August 2026 deadline for new AI systems

**Regulation:** EU AI Act (Article 113(a))
...
Practical checklist for engineering teams with AI features shipping before 2 Aug 2026.
...
The EU AI Act (Article 113(a)) is enforced as of Article 113(a). Non-compliance is a fine of up to €15M or 2.5-3% of global annual turnover (whichever is higher) for EU AI Act. Practitioners in scope need a deterministic, audit-ready reference — not a 200-page PDF.
...
Your agent will call the `eu-ai-act-compliance-mcp` tool, which references the EU AI Act Article 113(a) text directly. The response is structured:

```json
{
  "risk_class": "high",
  "applicable_articles": ["Article 113(a)", "Article 26"],
  "evidence_required": [
  ...
  "rationale": "The system processes health data of natural persons in the EU, falls within Annex III §5(a) (critical infrastructure), and meets the high-risk criteria in Article 113(a)."
}
```
