...
def list_standards(species: str = "trout", api_key: str = "") -> dict:
    ...
    if not allowed:
        return {"error": msg, "upgrade_url": "https://buy.stripe.com/8x28wR0xS7su23X7ew8k90z"}
    if not _check_rate_limit(tier):
        return {"error": "Rate limit exceeded. Upgrade at https://buy.stripe.com/8x28wR0xS7su23X7ew8k90z"}
